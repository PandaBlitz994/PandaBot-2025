...
# runs
def blue():
    chassis.settings(turn_rate=100, straight_speed=300)
...
def black():
    ...
    turn_to(-90)
    chassis.settings(turn_rate=25, straight_speed=250)
    chassis.straight(-1300, then=Stop.NONE)
    turn_to(-135)
    straight_time(-200, 1500)
    chassis.straight(50)
    chassis.turn(-5)
    straight_time(-200, 1000)
    chassis.straight(105)
    chassis.settings(400, turn_rate=400)
